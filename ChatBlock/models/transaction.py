...
class Transaction:
    ...
    def __reduce__(self):
        return (self.__class__, (self.sender_id, self.receiver_id, self.sender_address, self.sender_private_key, self.receiver_address, self.value, self.type_of_transaction, self.nonce))
