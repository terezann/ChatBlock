...
class Transaction:
    ...
    def __init__(self, sender_id, receiver_id, sender_address, sender_private_key, receiver_address, value, type_of_transaction, nonce, is_first):
    ...
    def set_cost(self):
        if self.type_of_transaction == 'money':
            return self.value
    ...
    def __reduce__(self):
        return (self.__class__, (self.sender_id, self.receiver_id, self.sender_address, self.sender_private_key, self.receiver_address, self.value, self.type_of_transaction, self.nonce, self.is_first))
